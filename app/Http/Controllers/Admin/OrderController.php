...
class OrderController extends Controller
{
    public function list($status)
    {
        ...
        //$orders = winnerorder::with('orderid','getUser','getShippingAddress')->get()->toArray();
         $orders = winnerorder::with('getUser','getShippingAddress')->get()->toArray();
        // print_r($orders);
        // exit;
        return view('admin-views.order.orders', compact('orders'));
    }
