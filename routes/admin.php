...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.'], function () {
            ...
            // Route::get('/prd/{id}','ProductsController@store')->name('prd'); //display product details
       

            Route::get('view/{id}', 'ProductController@view')->name('view');
            Route::get('remove-image/{productid}/{imgid}', 'ProductController@remove_image')->name('remove-image');
            //ajax request
        ...
        Route::group(['prefix' => 'category', 'as' => 'category.'], function () {
            ...
            Route::post('search', 'CategoryController@search')->name('search');
             Route::post('fileimport', 'CategoryController@fileimport')->name('fileimport');
        });
