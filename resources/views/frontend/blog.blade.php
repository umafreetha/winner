...
<html lang="en">
  ...
  <body>
    ...
    <header>
      <div class="top-header">
        ...
        <div class="rpart">
          <div class="country">
            <div id="country" class="select"><img src="images/franch-flag-icon.jpg" alt="flag" />French</div>
            <div id="country-drop" class="dropdown">
              <ul>
                <li><img src="images/franch-flag-icon.jpg" alt="flag" />French</li>
                <li><img src="images/india-flag-icon.jpg" alt="flag" />India</li>
              </ul>
            </div>
          </div>
          <div class="currency">
            <div class="btn dropdown-toggle" data-toggle="dropdown" data-rel="currency"><i class="icon-dollar-symbol"></i>usd <i class="icon-angle-down"></i></div>
        ...
        <div class="container">
          ...
          <nav class="navbar">
            ...
            <div class="collapse" id="organic-food-navigation">
              ...
              <div class="menu-logo"><a href="index.html"><img src="images/logo.png" alt="logo" /></a></div>
              <ul class="nav navbar-nav">
                <li><a href="index.html">Home</a></li>
                <li><a href="about.html">About</a></li>
                <li class="megamenu-li">
                  <a href="product-listing.html">Shop</a><span class="icon-angle-down"></span>
                  <div class="megamenu">
                    <div class="menu-part">
                      <div class="col">
                        <div class="menu-tit">Regular Fruits</div>
                        <ul>
                      ...
                      <div class="col">
                        <div class="menu-tit">Seasonal Fruits</div>
                        <ul>
                      ...
                      <div class="col">
                        <div class="menu-tit">Exotics Fruits</div>
                        <ul>
                      ...
                      <div class="col">
                        <div class="menu-tit">Imported Fruits</div>
                        <ul>
                      ...
                      <div class="col">
                        <div class="menu-tit">Citrus Fruits</div>
                        <ul>
                      ...
                      <div class="col">
                        <div class="menu-tit">Dry Fruits</div>
                        <ul>
                    ...
                    <div class="img-part"> <img src="images/megamenu-img.jpg" alt="megamenu-add" /> </div>
                  </div>
                </li>
                <li class="droapdown">
                  <a href="#">Organic Fruits</a><span class="icon-angle-down"></span>
                ...
                <li class="droapdown">
                  <a href="#">Pages</a><span class="icon-angle-down"></span>
                  <ul class="droapdown-menu">
  ...
  <section class="sub-banner">
    ...
    <img src="images/cart-page-banner.jpg" alt="banner" class="banner" />  
    </section>
    <!-- /Banner --> 
    <!-- Breadcrumb --> 
          ...
          <div class="col-md-3 col-sm-12 col-xs-12  pull-right">
            <aside id="blog_sidebar">
              ...
              <div class="blog_sidebar_widget popular-product-widget hidden-sm hidden-xs">
                ...
                <div class="box">
                  <div class="img-part">
                    <img src="images/blog-1.jpg" alt="blog post" class="img-fluid" />
                  </div>
                  <div class="txt-part">
                    <a class="blog-tit" href="#">Cucumber soup. Try our recipe!</a><br>
                    <a href="#" class="blog-date"><i class="icon-clock"></i>April 30, 2018</a> 
                  </div>
                </div>
                <div class="box">
                  <div class="img-part">
                    <img src="images/blog-4.jpg" alt="blog post" class="img-fluid" />
                  </div>
                  <div class="txt-part">
                    <a class="blog-tit" href="#">Why Farm Organically?</a> <br>
                    <a href="#" class="blog-date"><i class="icon-clock"></i>April 30, 2018</a> 
                  </div>
                </div>
                <div class="box">
                  <div class="img-part">
                    <img src="images/blog-7.jpg" alt="blog post" class="img-fluid" />
                  </div>
                  <div class="txt-part">
                    <a class="blog-tit" href="#">Food is everything we are</a> <br>
                    <a href="#" class="blog-date"><i class="icon-clock"></i>April 30, 2018</a> 
                  </div>
                </div>
              </div>
              ...
              <div class="blog_sidebar_widget popular-product-widget hidden-sm hidden-xs">
                ...
                <div class="post-cetegory">
                  <ul>
                    <li>
                      <div class="post-cetegory-header"><a class="" href="#">Berries  (8)</a></div>
                    </li>
                    <li>
                      <div class="post-cetegory-header"><a class="" href="#">Beverage  (13)</a></div>
                    </li>
                    <li>
                      <div class="post-cetegory-header"><a class="" href="#">Cereals  (8)</a></div>
                    </li>
                    <li>
                      <div class="post-cetegory-header"><a class="" href="#">Dairy  (8)</a></div>
                    </li>
                    <li>
                      <div class="post-cetegory-header"><a class="" href="#">Fruits  (11)</a></div>
                    </li>
                    <li>
                      <div class="post-cetegory-header"><a class="" href="#">Salad  (8)</a></div>
                    </li>
                    <li>
                      <div class="post-cetegory-header"><a class="" href="#">Tropical  (4)</a></div>
                    </li>
                    <li>
                      <div class="post-cetegory-header"><a class="" href="#">Uncategorized  (0)</a></div>
                    </li>
                    <li>
                      <div class="post-cetegory-header"><a class="" href="#">Vegetables  (11)</a></div>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-4 col-sm-6 col-xs-12 blog-list-detail">
                <div class="blog-list">
                  ...
                  <div class="blog-info">
                    <ul>
                      <li><a href="#"><i class="icon-clock"></i>April 30, 2018</a></li>
                      <li><a href="#"><i class="icon-interface"></i>0 Comments</a></li>
                    </ul>
                    <h2 class="text-left text-uppercase"><a href="blog-detail.html">Green Tea for Change Your Eating Food</a></h2>
                    <a href="blog-detail.html" class="rd-mr text-uppercase">read more</a>
                  </div>
                </div>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 blog-list-detail">
                <div class="blog-list">
                  ...
                  <div class="blog-info">
                    ...
                    <h2 class="text-left text-uppercase"><a href="#">Organic Food for Highly Active People</a></h2>
                    <a href="#" class="rd-mr text-uppercase">read more</a>
                  </div>
                </div>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 blog-list-detail">
                <div class="blog-list">
                  ...
                  <div class="blog-info">
                    ...
                    <h2 class="text-left text-uppercase"><a href="#">6 Reasons you should Switch to an Organic</a></h2>
                    <a href="#" class="rd-mr text-uppercase">read more</a>
                  </div>
                </div>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 blog-list-detail">
                <div class="blog-list">
                  <figure><img class="img-responsive" src="images/blog-4.jpg" alt="" /></figure>
                  <div class="blog-info">
                    <ul>
                      <li><a href="#"><i class="icon-clock"></i>April 30, 2018</a></li>
                      <li><a href="#"><i class="icon-interface"></i>0 Comments</a></li>
                    </ul>
                    <h2 class="text-left text-uppercase"><a href="#">14 Reasons to Drink Organic Green Tea</a></h2>
                    <a href="#" class="rd-mr text-uppercase">read more</a>
                  </div>
                </div>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 blog-list-detail">
                <div class="blog-list">
                  <figure><img class="img-responsive" src="images/blog-5.jpg" alt="" /></figure>
                  <div class="blog-info">
                    <ul>
                      <li><a href="#"><i class="icon-clock"></i>April 30, 2018</a></li>
                      <li><a href="#"><i class="icon-interface"></i>0 Comments</a></li>
                    </ul>
                    <h2 class="text-left text-uppercase"><a href="#">Tips for Growing your own Organic Produce</a></h2>
                    <a href="#" class="rd-mr text-uppercase">read more</a>
                  </div>
                </div>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12  blog-list-detail">
                <div class="blog-list">
                  <figure><img class="img-responsive" src="images/blog-6.jpg" alt="" /></figure>
                  <div class="blog-info">
                    <ul>
                      <li><a href="#"><i class="icon-clock"></i>April 30, 2018</a></li>
                      <li><a href="#"><i class="icon-interface"></i>0 Comments</a></li>
                    </ul>
                    <h2 class="text-left text-uppercase"><a href="#">Top 9 Best Organic Foods for Highly </a></h2>
                    <a href="#" class="rd-mr text-uppercase">read more</a>
                  </div>
                </div>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 blog-list-detail">
                <div class="blog-list">
                  <figure><img class="img-responsive" src="images/blog-7.jpg" alt="" /></figure>
                  <div class="blog-info">
                    <ul>
                      <li><a href="#"><i class="icon-clock"></i>April 30, 2018</a></li>
                      <li><a href="#"><i class="icon-interface"></i>0 Comments</a></li>
                    </ul>
                    <h2 class="text-left text-uppercase"><a href="#">Eating Habits with this Organic Food</a></h2>
                    <a href="#" class="rd-mr text-uppercase">read more</a>
                  </div>
                </div>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 blog-list-detail">
                <div class="blog-list">
                  <figure><img class="img-responsive" src="images/blog-8.jpg" alt="" /></figure>
                  <div class="blog-info">
                    <ul>
                      <li><a href="#"><i class="icon-clock"></i>April 30, 2018</a></li>
                      <li><a href="#"><i class="icon-interface"></i>0 Comments</a></li>
                    </ul>
                    <h2 class="text-left text-uppercase"><a href="#">5 Ways to Live an Organic Lifestyle</a></h2>
                    <a href="#" class="rd-mr text-uppercase">read more</a>
                  </div>
                </div>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 blog-list-detail">
                <div class="blog-list">
                  <figure><img class="img-responsive" src="images/blog-9.jpg" alt="" /></figure>
                  <div class="blog-info">
                    <ul>
                      <li><a href="#"><i class="icon-clock"></i>April 30, 2018</a></li>
                      <li><a href="#"><i class="icon-interface"></i>0 Comments</a></li>
                    </ul>
                    <h2 class="text-left text-uppercase"><a href="#">Healthy Living lismod  Recipes</a></h2>
                    <a href="#" class="rd-mr text-uppercase">read more</a>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                  <div class="pagination text-center">
                    <a class="left" href="#"><i class="icon-right-arrow"></i>prev</a>
                    <a href="#">1</a>
                    <a class="active" href="#">2</a>
                    <a href="#">3</a>
                    <a href="#">4</a>
                    <a href="#">5</a>
                    <a class="right" href="#">next<i class="icon-right-arrow"></i></a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="top-footer">
            <div class="col-md-3 col-sm-12 col-xs-12">
              ...
              <div class="logo-btm">
                <div class="adress"><i class="icon-placeholder"></i><span>Lorem Ipsum is dummy text of the printing typesetting</span></div>
                <div class="phone"><i class="icon-icon"></i><a href="tel:+8888888888">+(888) 888-8888</a></div>
                <div class="mail"><i class="icon-envelope"></i><a href="mailto:inquiry@organicfoodstroe.com">inquiry@organicfoodstroe.com</a></div>
              </div>
            </div>
          ...
          <div class="bottom-footer">
            <div class="lpart">
              ...
              <p class="design">Website designed & Developed by <a target="_blank" href="https://www.ncodetechnologies.com/">NCode Technologies, Inc.</a></p>
            </div>
