                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{$categories->name}}" class="form-control" placeholder="">
                            </div>
                            <div class="form-group">
                                <input type="hidden" name="old_image" value="{{$categories->image}}" class="form-control" placeholder="">
                            </div>
                            <input name="position" value="" style="display: none">
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                        ...
                        <div class="col-12">
                            <center>
                                <img style="width: 30%;border: 1px solid; border-radius: 10px;" id="viewer"
                                     src="../../../storage/category/{{$categories->image}}" alt=""/>
                            </center>
                        </div>
                    </div>
                    <hr>
